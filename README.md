...
cd backend && pytest       # 480 offline tests — no network, no API quota
```
...
│   └── tests/                   # 27 files, 480 offline tests
├── frontend/src/
...
**480 backend tests offline** (plus 9 real-HTTP, 7 live-API and 3 real-embedding, deselected
by default) and
**181 frontend tests**, all green. Security- and correctness-critical assertions are
